...
$query = "SELECT * FROM products WHERE category = 'Home & Furniture'";
...
<body class="min-h-screen bg-gradient-to-r from-orange-200 via-pink-400 to-purple-300">
  ...
  <div class="bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500  flex flex-col sm:flex-row sm:justify-between sm:items-center px-4 py-2 mb-2 shadow-md rounded-b-xl relative gap-3">
    <div class="relative">
      <button id="toggleMenu" class="bg-gradient-to-r from-red-400 via-pink-500 to-purple-500 text-white px-4 italic py-3 rounded-full text-sm font-semibold shadow hover:opacity-90 transition">
        SUB-CATEGORY
      </button>
      <div id="subcategoryMenu" class="absolute mt-2 bg-white bg-opacity-70 backdrop-blur-md rounded shadow-md hidden text-sm z-10">
        <form method="get">
          <button name="subcategory" value="All" class="block px-4 py-2 hover:bg-pink-100 w-full text-left font-semibold text-purple-700">All Furniture</button>
          <button name="subcategory" value="Sofa" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Sofa</button>
          <button name="subcategory" value="Bed" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Bed</button>
          <button name="subcategory" value="Table" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Table</button>
          <button name="subcategory" value="Chair" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Chair</button>
    ...
    <form method="get" class="flex items-center">
      ...
      <button type="submit" class="px-4 py-1 italic bg-gradient-to-r from-red-400 via-pink-500 to-purple-500 text-white rounded-r-full hover:bg-pink-600 transition text-sm">Search</button>
    </form>

...
<body class="min-h-screen bg-gradient-to-r from-orange-200 via-pink-400 to-purple-300">
  <div class="bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500  flex flex-col sm:flex-row sm:justify-between sm:items-center px-4 py-3 mb-2 shadow-md rounded-b-xl relative gap-3">
    <div class="relative">
      <button id="toggleMenu" class="bg-gradient-to-r from-red-400 via-pink-500 to-purple-500 text-white px-4 py-2 italic rounded-full text-sm font-semibold shadow hover:opacity-90 transition">
        SUB-CATEGORY
      </button>
      <div id="subcategoryMenu" class="absolute mt-2 bg-white bg-opacity-70 backdrop-blur-md rounded shadow-md hidden text-sm z-10">
        <form method="get">
          <button name="subcategory" value="All" class="block px-4 py-2 hover:bg-pink-100 w-full text-left font-semibold text-purple-700">All Clothing</button>
          <button name="subcategory" value="Men" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Men</button>
          <button name="subcategory" value="Women" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Women</button>
          <button name="subcategory" value="Kids" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Kids</button>
          <button name="subcategory" value="Traditional" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Traditional</button>
    ...
    <a href="cart.php" class="bg-gradient-to-r from-yellow-400 via-red-400 to-pink-400 text-white italic px-3 py-1 rounded-full text-sm font-semibold shadow hover:opacity-90 transition">
      ...
      <a href="logout.php" onclick="return confirm('Are you sure you want to logout?');"
         class="bg-gradient-to-r from-red-400 via-pink-500 to-purple-500 text-white italic px-4 py-2 rounded-full text-sm font-semibold shadow hover:opacity-90 transition">
          Logout
      </a>
    </div>
  </div>

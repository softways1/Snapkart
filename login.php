...
<body>
    ...
    <div class="flex justify-center items-start pt-14 bg-gradient-to-r from-orange-100 via-pink-300 to-purple-200 h-screen">
        <div class="flex flex-col h-auto w-[13cm] p-6 bg-gradient-to-r from-orange-300 via-pink-300 to-blue-300 rounded-2xl shadow-2xl border border-gray-300">
            ...
            <form method="POST" action="login.php" class="space-y-2">
                <div>
                    <label class="font-semibold bg-gradient-to-r from-orange-500 via-pink-600 to-blue-600 text-transparent bg-clip-text">
                        I am a:
                    </label>
                    <select name="usertype" required class="block w-full border border-gray-400 rounded p-2 text-black">
                ...
                <button type="submit" name="login" class="w-full mt-4 bg-gradient-to-r from-orange-400 via-pink-500 to-blue-500 text-white font-bold p-2 rounded hover:opacity-90 ">
                    Login
                </button>
            </form>
            ...
            <div class="mt-6 p-4 rounded-xl">
                ...
                <div class="flex justify-center gap-4">
                    <a href="customer_register.php" class="px-4 py-2 bg-gradient-to-r from-orange-400 via-pink-500 to-blue-500 text-white rounded-lg font-semibold hover:opacity-90 transition">
                        Register as Customer
                    </a>
                    <a href="seller_register.php" class="px-4 py-2 bg-gradient-to-r from-orange-400 via-pink-500 to-blue-500 text-white rounded-lg font-semibold hover:opacity-90 transition">
                        Register as Seller
                    </a>
                </div>
            </div>

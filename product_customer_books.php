...
$query = "SELECT * FROM products WHERE category = 'Books & Stationery'";
...
<body class="min-h-screen bg-gradient-to-r from-orange-100 via-pink-300 to-purple-200 p-4">
  ...
  <div class="flex justify-between items-center mb-6 bg-gradient-to-r from-orange-100 via-pink-300 to-purple-200 p-4 rounded-xl shadow">
    <div class="relative">
      ...
      <div id="subcategoryMenu" class="absolute mt-2 bg-white bg-opacity-70 backdrop-blur-md rounded shadow-md hidden text-sm z-10">
        <form method="get">
          <button name="subcategory" value="All" class="block px-4 py-2 hover:bg-pink-100 w-full text-left font-semibold text-purple-700">All</button>
          <button name="subcategory" value="Notebook" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Notebook</button>
          <button name="subcategory" value="Textbook" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Textbook</button>
          <button name="subcategory" value="Stationery" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Stationery</button>
          <button name="subcategory" value="Magazine" class="block px-4 py-2 hover:bg-pink-100 w-full text-left">Magazine</button>
  ...
  <?php } else { ?>
    <div class="mt-20 text-center p-6 rounded-xl bg-white bg-opacity-60 backdrop-blur-md shadow text-purple-900 text-lg font-semibold max-w-lg mx-auto">
      <p class="mb-2">Sorry, no books or stationery in stock.</p>
